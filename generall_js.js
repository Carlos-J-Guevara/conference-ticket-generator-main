...
const userAvatarUploadIcon =
  document.getElementById('infoiconupload') || undefined;
const avatarUploadInstruction =
  document.getElementById('intructionsizeofimage') || undefined;
const avatarUploadGuide =
  document.getElementById('dragAndDropMessage') || undefined;
// DOM of email address
const emailAvatarUploadInput =
  document.getElementById('uploademailaddress') || undefined;
const emailIconAvatarUploadInput =
  document.getElementById('iconemailaddress') || undefined;
const emailInstructionAvatarUploadInput =
  document.getElementById('instrutionsemailaddress') || undefined;
// DOM of Full name.
const fullNameAvatarUploadInput =
  document.getElementById('uploadfullnamefield') || undefined;
// DOM of github username.
const githubUsernameAvatarUploadInput =
  document.getElementById('uploadgithubusername') || undefined;
// DOM of generate botom
const generateButtonticket =
  document.getElementById('generatebutton') || undefined;
...
function validateAllFields() {
  return (
    ...
    validateEmail(
      (emailAvatarUploadInput === null || emailAvatarUploadInput === void 0
        ? void 0
        : emailAvatarUploadInput.value) || ''
    ).isValid &&
    validateFullName(
      (fullNameAvatarUploadInput === null ||
      fullNameAvatarUploadInput === void 0
        ? void 0
        : fullNameAvatarUploadInput.value) || ''
    ).isValid &&
    validateGithubUsername(
      (githubUsernameAvatarUploadInput === null ||
      githubUsernameAvatarUploadInput === void 0
        ? void 0
        : githubUsernameAvatarUploadInput.value) || ''
    ).isValid
  );
}
...
const serialOfticketDiv =
  document.getElementById('serialOfTicket') || undefined;
const previewInTicket =
  document.getElementById('previsualitationOfownerTicket') || undefined;
